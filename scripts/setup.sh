...
echo ""
curl https://raw.githubusercontent.com/cabberley/azure-hcl-nested/main/azuredeploy.json -o azuredeploy1.json > /dev/null 2>&1
$az deployment sub create --template-file azuredeploy1.json  --no-wait \
  --location $LOCATION \
